...
define("components/project-list", ["require", "exports", "state/project-state", "components/base-component", "models/project", "decorators/autobind", "components/project-item"], function (require, exports, project_state_js_1, base_component_js_2, project_js_2, autobind_js_2, project_item_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectInput extends base_component_js_3.Component {
        ...
        submitHandler(event) {
            ...
            if (Array.isArray(userInput)) {
                ...
                project_state_js_2.projectState.addProject(title, desc, people);
                this.clearInputs();
            }
        }
    }
